...
public class BoardTest {
	...
	/**
	 * Verifies the square at x0y2 is indeed the right square.
	 */
	@Test
	public void verifyX0Y2(){
		assertEquals(x0y2, board.squareAt(0, 2));
	}
	
	/**
	 * test withinBorders(0,1) works
	 */
	@Test
	public void testWithinBorders(){
		assertEquals(true, board.withinBorders(0, 1));
	}
}
